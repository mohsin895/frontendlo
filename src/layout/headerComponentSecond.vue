<template>
  <div class="header unselectable">
          ...
          <div class="menu-part">
            <div class="menu-top">
              <div class="container-width">
                <div class="mune-top-left" style="width: 50%">
                  <!-- <router-link :to="{name:'premiumPackge'}">
                              <b-icon icon="gift"></b-icon>
                              Premium Package
                          </router-link> -->
                </div>
                <div class="menu-top-right" style="width: 50%">
                  <div style="float: right">
                    <slot v-if="$store.state.sellerInfo != null">
                      <router-link :to="{ name: 'sellerDashboard' }"
                        >Sell On Loyel</router-link
                      >
                    </slot>
                    <slot v-else>
            ...
            <div class="loyel-container">
              <div class="menu-bottom">
                <div class="loyel-container menu-bottom-first">
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                              <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  <li
                                    class="nav-item dropdown-submenu category-figure"
                                    v-for="(
                                      megaCategory, megaIndex
                                    ) in categoryList"
                                    :key="megaIndex"
                                  >
                                    <a
                                    ...
                                    <slot
                                      v-if="
                                        megaCategory.sub_category.length != null
                                      "
                                    >
                                      <ul class="dropdown-menu">
                                        <li
                                          ...
                                          ) in megaCategory.sub_category"
                                          :key="subCategoryIndex"
                                        >
                                          <a
                                            class="nav-link dropdown-submenu-toggle"
                                            href="#"
                                            role="button"
                                            data-bs-toggle="dropdown"
                                            aria-expanded="false"
                                          ...
                                          <ul
                                            class="dropdown-menu child-child-category"
                                            v-if="
                                          ...
                                          >
                                            <li
                                              v-for="(
                                                normalCategory,
                                                normalCategoryIndex
                                              ) in subCategory.sub_category"
                                              :key="normalCategoryIndex"
                                            >
                                              <a
                                                class="nav-link dropdown-sub-submenu-toggle"
                                                href="#"
                                                @click="
                                                  gotoSubCategoryPage(
                                                    normalCategory
                  ...
                  <div class="loyel-search-bar">
                    <div class="search-bar">
                      <Search />
                    </div>
                  </div>
                  <div class="loyel-profile">
                    <div class="righ-part">
                      <div class="news-feed">
                      ...
                      <div class="icon-list">
                          ...
                          <div class="wishlist">
                            <router-link
                              :to="{
                                name: 'Wishlist',
                                params: {
                                  name: $store.state.customerInfo.name
                                    .split(' ')
                                    .join('-'),
                                },
                              }"
                        ...
                        <router-link :to="{ name: 'Wishlist', params: { name: $store.state.customerInfo.name.split(' ').join('-') } }">
                          <b-icon icon="heart-fill"></b-icon>
                          <span class='badge badge-warning' id='lblCartCount'> {{ wishListCount }} </span>
                        </router-link>
                    ...
                    <div class="container-fluid">
                      ...
                      >
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                          ...
                          <li>
                            <router-link to="/comboOffer"
                              >Combo Offer</router-link
                            >
                          </li>
                          ...
                          <li>
                            <router-link to="/all-vandor" class="vendor"
                              >All Vendors</router-link
                            >
                          </li>
    ...
    <nav class="mobile-header-main" style="height: 76px">
      <sliding-header :threshold-hide="200" :threshold-open="400">
        <template v-slot:first-header>
          <div class="menu-part">
            <div class="menu-top">
            ...
            <div class="loyel-container">
              <div class="menu-bottom">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              >
                                <a
                                  ...
                                  data-bs-toggle="dropdown"
                                  aria-expanded="false"
                                  @click="gotoCategoryPage(megaCategory)"
                                >
                                  {{ megaCategory.title }}
                                </a>
                                <slot
                                ...
                                >
                                  <ul class="dropdown-menu">
                                    ...
                                    >
                                      ...
                                      <ul
                                        class="dropdown-menu child-child-category"
                                        v-if="subCategory.sub_category != null"
                                      >
                                        <li
                                          v-for="(
                                            normalCategory, normalCategoryIndex
                                          ) in subCategory.sub_category"
                                          :key="normalCategoryIndex"
                                        >
                                          <a
                                            ...
                                            href="#"
                                            @click="
                                              gotoSubCategoryPage(normalCategory)
                                            "
                                            >{{ normalCategory.title }}</a
                                          >
                                        </li>
                ...
                <li>
                  <router-link to="/feature-product">Featured Products</router-link>
                </li>
                <li>
                  <router-link to="/todayDeal">Todays Deal</router-link>
                </li>
        ...
        <template v-slot:second-header>
          <div class="menu-part-second">
            <div class="loyel-container">
              <div class="menu-bottom">
                <div
                  class="loyel-container menu-bottom-first mobile-header-slide"
                >
                  <router-link to="/">
                    <div class="logo">
                      <span ckass="logo">
    ...
    <nav class="mobile-header">
      <router-link :to="{ name: 'MobileCategory' }">
        <label for="drop" class="toggle-category"
          ><img
            class="google-img"
      ...
      <div class="categories">
        <div class="loyel-container brands-top"></div>
        <CategorySlider />
      </div>
