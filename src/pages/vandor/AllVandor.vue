            ...
            <div class="loyel-container brand-and-products-wrapper">
                ...
                <div class="right-products-display">
                    <div class="product-slider">
                        <div class="row">
                            <div class="col mt-2" v-for="(vandorInfo, vendorIndex) in vandorList" :key="vendorIndex">
                                <div class="product" @click="gotoVandorProductPage(vandorInfo)">
                                    <div class="card">
                                        <div class="product-box">


                                            <div class="image"
                                                v-bind:style="{ 'background-image': 'url(' + baseUrl + vandorInfo.shop_banner + ')' }">
                                                <p class="shop-name"> {{ (vandorInfo.shop_name.length > 15) ?
                                                    vandorInfo.shop_name.substr(0, 15) + '...' : vandorInfo.shop_name }}</p>
                                                <!-- <slot v-if="vandorInfo.shop_logo!=null">
                                                    <img v-lazy="vandorInfo.shop_logo" alt="vandorInfo.shop_name">
                                                </slot> -->

                                            </div>
                                            <img :src="baseUrl + vandorInfo.shop_logo" alt="Avatar" class="store-image">
                                            <!-- <div class="description">
                                            

                                                    {{(vandorInfo.shop_name.length > 15)? vandorInfo.shop_name.substr(0,15)+'...' : vandorInfo.shop_name}}
...
import Search from '@/pages/vandor/Search'
...
export default {
    ...
    methods: {
        gotoVandorProductPage(vandorInfo) {
            this.$router.push({ name: 'shop', params: { slug: vandorInfo.slug.split(' ').join('-') } });
        },
        getVandorList() {
            this.$http.get("get/shop/list")
                .then(response => {
                    this.vandorList = response.data;
                })
