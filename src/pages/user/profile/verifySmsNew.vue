                ...
                <div class="bnk-inner-part">
                    <b-row cols="1" cols-md="2" cols-lg="2">
                        ...
                        <b-col>
                            ...
                            <p>Enter Verify SMS Code:
                                 <input type="text" placeholder="Enter SMS Code" class="form-control" v-model="smsCode">
                    ...
                    <b-row cols="1" cols-md="2" cols-lg="3">
                        ...
                        <b-col class="text-right">
                            <button class="btn btn-sm btn-info" @click="verifyPhone">
                              Verify
                            </button>
                        </b-col>
                    </b-row>
              ...
              let token=window.localStorage.getItem("customerToken");
               ...
               let config = {
                 ...
                 formData.append("smsCode", this.smsCode);
                  await this.$http.post("customer/sms/verify/phone",formData,config)
                          .then(response=>{
                            ...
                            if(response.data.msgFlag==true){
                                ...
                                this.$router.push({name:'customerProfileEdit'});
                            }
