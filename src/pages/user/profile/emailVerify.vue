    ...
    <div class="customer">
        <div class="loyel-customer-box">
            ...
            <div class="loyel-customer-box-item" >
                ...
                <hr>
                <div class="loyel-customer-email-verify-otp">
                    ...
                    <b-row cols="1" cols-md="2" cols-lg="3">
                        ...
                        <b-col class="text-right">
                            <button class="btn btn-sm cutomer-verify-email-button " @click="verifyEmail">
                              Verify
                            </button>
                        </b-col>
                    </b-row>
...
.loyel-customer-email-verify-otp {
    padding: 15px 10px;
}
.cutomer-verify-email-button {
    background: #1877f2;
    color:#fff;
}
