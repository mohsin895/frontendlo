<template>
    <div class="signup-customer-login" ref="top">
...
export default {
    ...
    methods: {
      ...
      window.scrollTo(0, 0); // Scrolls to the top-left corner of the page
        ...
        loginWithGoogle() {
      window.location.href = 'https://seller.loyel.com.bd/loyelApi/public/auth/google'; // Redirect to Laravel route
    },
    formSubmitPrevent(e) {
            // e.preventDefault();
        },
