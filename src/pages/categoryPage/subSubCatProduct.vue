<template>
  <div class="sub-subcategory-page">
    <div class="loyel-container">
      <br />
      <div></div>
      <span class="subcategory-breadcrub" v-if="categoryInfo && categoryInfo.parent_info">
        <router-link to="/" class="home-breadcrub">
          <span class="product-breadcrub">Home</span></router-link
        ><span class="third-breadcrub">/</span
        ><span
          class="third-breadcrub"
          @click="gotoCategoryPage(categoryInfo.parent_info)"
          >{{ rootCategoryInfo.title }}</span
        ><span class="third-breadcrub">/</span
        ><span
          class="third-breadcrub"
          @click="gotoCategoryPage(categoryInfo.parent_info)"
          >{{ categoryInfo.parent_info.title }}</span
        ><span class="third-breadcrub">/</span
        ><span
          class="third-breadcrub"
          @click="gotoCategoryPage(categoryInfo.parent_info)"
      ...
      <!-- <div class="dropdown-select mt-2">
      ...
      <div class="loyel-container category-and-products-wrapper">
        <div class="left-side-sub-subcategory-page">
          <!-- <div class="cateogry">
                        <div class="heading-sub-subcategory-sorting">Categories</div>
          ...
          <div class="loyel-sub-subcategory-left-side-sorting">
            <div class="loyel-brands-sorting-sub-subcategory">
              <div class="heading-sub-subcategory-sorting">Brands</div>
            ...
            <div class="loyel-colors-sorting-sub-subcategory">
              <div class="heading-sub-subcategory-sorting">Color List</div>
            ...
            <div class="loyel-price-sorting-category">
              <div class="heading-sub-subcategory-sorting">Price</div>
        ...
        <div class="right-products-display-sub-sub-category">
          ...
          <div class="left-side-category-page-mobile">
            <div class="loyel-category-left-side-sorting-mobile">
              ...
              <div class="loyel-colors-sorting-category">
                ...
                >
                  <option
                    v-for="(sizeOption, index) in sizeList"
                    :value="sizeOption.id"
                    :key="sizeOption.id"
                    :selected="index === 0"
                  >
                ...
                <ul>
                  <slot v-if="selectedSize !== ''">
                    <li
                      v-for="(sizeAttribute, index) in sizeAttributeList"
                      :key="index"
                    >
                      <input
                        type="checkbox"
...
export default {
  ...
  data() {
    return {
      ...
      dataUrl: "subCategory/wise/product",
      totalData: 0,
      brandList: [],
      colorList: [],
      numberOfDataPage: 1,
  ...
  metaInfo() {
    return {
      ...
      link: [
        { rel: "canonical", href: this.siteUrl + "/subcategory/" + this.slug },
      ],
      meta: [
        {
          name: "description",
      ...
      this.$http
        ...
        .then((response) => {
          if (response.data.msgFlag == true) {
            ...
            this.rootCategoryInfo = response.data.parentCat;
...
@media (min-width: 1450px) {
  ...
  .right-products-display-sub-sub-category {
...
@media (min-width: 1px) and (max-width: 767px) {
  ...
  .left-side-sub-subcategory-page {
    display: none;
  }
}
...
.heading-sub-subcategory-sorting {
  width: 95%;
  padding: 8px;
  /* background: #E1E1E1; */
  font-weight: 600;
...
.loyel-sub-subcategory-left-side-sorting {
  background-color: #fff;
  border-radius: 4px;
  padding: 0 12px 12px;
}
