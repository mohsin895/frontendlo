<template>
    <div class="loyel-feature-product">
...
export default {
    ...
    data() {
        return {
            ...
            dataUrl:'feature/wise/product',
            totalData:0,
            numberOfDataPage:1,
            sortBy:'new',
            lastPage:1,
            dataList:[],
            msg:'loyel-feature-product',
            hooperSettings: {
                itemsToShow: 6,
                itemsToSlide:1,
                infiniteScroll: true,
    ...
    methods: {
        ...
        getDataList() {
          ...
          this.$http.get("feature/wise/product?page="+this.pageNo+"&numOfData="+this.numOfData, {
        params: {
            sort_by: this.sortBy,
        },
      })
