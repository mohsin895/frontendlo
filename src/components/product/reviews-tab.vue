<template>
    <div class="overview-review">
        <div class="rating-review-desktop">
            <div class="heading">
            Ratings & Reviews of {{$store.state.productInfos.name}}
        </div>
        <div class="tab-body">
            <div class="tab-container">
                <b-row cols="1" cols-sm="1" cols-lg="3">
                    <b-col>
                        <div class="big-rating-mobile">
        ...
        <div class="reviewer-list">
            ...
            <div class="review-list-body">
                <div class="single-review" v-for="review in productReview " :key="review.id">
                    <div class="tab-container">
                        <div class="first-step">
                            ...
                            <div class="reviewe-timer">
                                {{review.created_at |formatDateWithDay}}
                            </div>
                        </div>
        ...
        <div class="rating-review-mobile">
            <div class="heading">
        ...
        <div class="tab-body">
            <div class="tab-container">
                <b-row cols="1" cols-sm="1" cols-lg="3">
                    <b-col>
                        <div class="big-rating-mobile">
                            <div class="rating-number-mobile">
                                <span>{{totalrating}}</span> <span>/5</span>
                            </div>
                            <div class="mobile-total-rating">
                                <div class="ratings" v-if="totalrating==5">
                                <Rating 
                                size="10px"
                                :value="5"
            ...
            <div class="review-list-body">
                <div class="single-review" v-for="review in productReview " :key="review.id">
                    <div class="tab-container">
                        <div class="first-step">
                            <div>
                                <div class="reviewer-name-mobile">
                                    <div>
                                        {{review.customer_info.name}} 
                                    </div>
                                    <div>
                                        <div class="reviewe-timer" style="padding-left: 5px;">
                                {{review.created_at |formatDateWithDay}}
                            </div>
                                    </div>
                        ...
                        <div class="second-step">
                            <div class="reviewer-comment-mobile">
...
import MobileRating from '@/components/product/mobile/rating-view'
import Review from '@/components/product/review-amount'
import ReviewMobile from '@/components/product/mobile/review-amount'
export default {
    name: 'overview-tab',
    props:{
...
.rating-number-mobile > :nth-child(1) {
    font-size: 1rem;
    color: black;
}
.rating-number-mobile > :nth-child(2) {
    font-size: 1rem;
}
.review-ratings > *{
    display: flex;
...
.reviewer-name-mobile{
    display: flex;
    font-size: 10px;
    justify-content: space-between;
}
.reviewer-comment-mobile{
    font-size: 12px;
}
.third-step-mobile{
    font-size: 12px;
