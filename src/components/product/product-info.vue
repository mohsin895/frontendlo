<template>
  <div class="product-info unselectable">
    <br />
    <h1 class="product-name">{{ $store.state.productInfos.name }}</h1>
    <div class="rating">
        ...
        <slot v-if="$store.state.productInfos.brand_info != null">
          <div class="brand">
            ...
            <router-link
              ...
              :to="{
                name: 'brandProduct',
                params: { slug: $store.state.productInfos.brand_info.slug },
              }"
            >
              <span>{{
                $store.state.productInfos.brand_info.name
              }}</span></router-link
            >
          </div>
        </slot>
      ...
      <slot
        v-if="
          isDiscountTimeExpireInfo(
            sizeWizePrice.startDate,
            sizeWizePrice.endDate
          )
        "
      >
      ...
      <div class="color-details">
        ...
        <div class="color-plate">
          ...
          >
            <div
              class="color-div"
              :id="'color_id_mobile' + colorInfo.color_id"
        ...
        <div class="size-attribute-plate">
          ...
          >
            ...
            <div
              ...
              :id="'size_attribute_id_mobile' + attributeInfo.size_attribute_id"
            >
      ...
      <div class="btn-group">
        <div
          ...
          @click="
            ...
            gotoCheckoutPage($store.state.productInfos);
          "
        >
          buy now
        </div>
...
export default {
  ...
  methods: {
    ...
    setColor(colorInfo) {
      ...
      $("#color_id_mobile" + colorInfo.color_id).addClass("color-active");
    ...
    //   $("#size_attribute_id_mobile" + attributeInfo.size_attribute_id).addClass(
  ...
  if (attributeInfo && attributeInfo.size_attribute_id ) {
    ...
    //     let flag = false;
    //     this.productId = productInfo.id;
    //     formData.append("sizeAttributeCode1", this.sizeAttributeCode);
      ...
      if (productInfo.has_size == 1 && productInfo.has_color == 1) {
        if (this.colorCode != 0 && this.sizeAttributeCode != 0) {
          ...
          if (this.sizeAttributeCode == 0)
            this.$toaster.warning("Select A Size  First.");
          if (this.colorCode == 0)
            this.$toaster.warning("Select A Color First.");
          return false;
        }
      } else {
    ...
    gotoBrandProductPage(brandInfo) {
      this.$router.push({
        name: "brandProduct",
        params: { slug: brandInfo.slug.split(" ").join("-") },
      });
    },
    //   getWishListCount(){
